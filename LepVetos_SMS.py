...
for cut in Cuts:
  for model in models:
      ...
      print model, cut
      FullCutFlowRootFile100 = r.TFile.Open("./VetosAndCleaningFiles/results_NoGenLeps_had_%s_100.root"%(model))
      NMinus1RootFile100 = r.TFile.Open("./VetosAndCleaningFiles/results_NoGenLeps_NoLepVeto_had_%s_100.root"%(model))
