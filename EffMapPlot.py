...
subDirListHigh = [
    "smsScan_eq0b_%s_AlphaT55_375_475"%jMulti,
    "smsScan_eq0b_%s_AlphaT55_475_575"%jMulti,
    "smsScan_eq0b_%s_AlphaT55_575_675"%jMulti,
    "smsScan_eq0b_%s_AlphaT55_675_775"%jMulti,
    "smsScan_eq0b_%s_AlphaT55_775_875"%jMulti,
    "smsScan_eq0b_%s_AlphaT55_875"%jMulti,
]
...
cutsJESPlusHist.Add(GetHist(File = centralRootFile87,folder = ["smsScan_eq0b_%s_AlphaT55_325_375"%jMulti],hist = "m0_m12_mChi_noweight", Norm = None ,rebinX= 1))
cutsJESPlusHist.Add(GetHist(File = centralRootFile73,folder = ["smsScan_eq0b_%s_AlphaT55_275_325"%jMulti],hist = "m0_m12_mChi_noweight", Norm = None ,rebinX= 1))
...
c1.Print("testEff_T2cc_%s_eq0b.pdf"%jMulti)
